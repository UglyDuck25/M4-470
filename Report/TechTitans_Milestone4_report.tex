...
Semgrep was run using Semgrep 1.156.0, installed in the Docker container.
...
\item Target: \texttt{gson/src/main/java}, covering 86 Java source files with tests excluded
\end{itemize}
